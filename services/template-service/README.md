...
- **API**: https://template-service-app.blacksky-6bcbe9ee.uksouth.azurecontainerapps.io/api/v1/
...
- Template → has many → TemplateVersions
- Template → has many → TemplateVariables
...
- Check API documentation: https://template-service-app.blacksky-6bcbe9ee.uksouth.azurecontainerapps.io/api/docs
- Review database schema: `npx prisma studio`
- Check health endpoint: https://template-service-app.blacksky-6bcbe9ee.uksouth.azurecontainerapps.io/api/v1/health
